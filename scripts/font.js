...
const FONTS = {
    ...
    symbols: ['Material Symbols Outlined', 'Material Symbols Rounded', 'Material Symbols Sharp'],
};

const AGENTS = {
    woff2: 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.77 Safari/537.36', // chrome 70
...
const getFontUrl = async (name, format, axes) => {
    ...
    const suffix = name.toLowerCase().includes('symbols') ? `:opsz,wght,FILL,GRAD@${size},${weight},${fill},${grade}` : '';
